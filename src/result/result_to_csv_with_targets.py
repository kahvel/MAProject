...
data_file_name = "results0.txt"
data_file_folder = "U:\\data\\my\\3_75_results\\"
data_file = open(data_file_folder + data_file_name)
file_content = data_file.readlines()
data_file.close()
result_file_name = data_file_name[:-4]+"1.csv"
...
result_content = "PSDA_sum_f1 PSDA_sum_f2 PSDA_sum_f3 PSDA_h1_f1 PSDA_h1_f2 PSDA_h1_f3 PSDA_h2_f1 PSDA_h2_f2 PSDA_h2_f3 CCA_f1 CCA_f2 CCA_f3 " + \
                 "LRT_f1 LRT_f2 LRT_f3 SNR_sum_f1 SNR_sum_f2 SNR_sum_f3 SNR_h1_f1 SNR_h1_f2 SNR_h1_f3 SNR_h2_f1 SNR_h2_f2 SNR_h2_f3 " +\
                 "class\n"
